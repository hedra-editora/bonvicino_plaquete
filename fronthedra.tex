...
%% Créditos ------------------------------------------------------
\raggedright
{\tiny{Poemas do livro inédito \emph{A nova utopia}, de Régis Bonvicino}}

\linhalayout{leitura dos poemas}{Caroline De Comi, Charles Bernstein e Régis Bonvicino}
\linhalayout{produção, sonorizações, mixagem e capa}{Rodrigo Dário}
\linhalayout{edição e captação de som}{Tamires Pistoresi}
\linhalayout{preparação dos textos do libreto}{Ieda Lebensztayn}
...
\linhalayout{imagens©}{Susan Bee}\smallskip
...
\linha{assistência editorial}{\assistencia}\smallskip
...
{\tiny{Gravado em São Paulo, de março a julho de 2019, no estúdio Espaço\\
Som, R~Teodoro Sampaio, 462 e 512, Pinheiros, 05405--050\\}}
