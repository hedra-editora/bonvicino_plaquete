...
\linhalayout{Diagramação}{Editora Hedra}
\linhalayout{Edição e captação de som}{Tamires Pistoresi}
\linhalayout{Preparação dos textos do libreto}{Ieda Lebensztayn}

{\tiny{Gravado em São Paulo, de março a julho de 2019, no estúdio Espaço\\ Som, Rua Teodoro Sampaio, 462 e 512, Pinheiros, CEP: 05405-050}}
